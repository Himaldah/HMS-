...
<div class="container mx-auto">
    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-6">
        <h2 class="text-xl font-semibold text-blue-700 mb-4">Fees Update</h2>
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="submit" class="bg-pink-500 text-white px-4 py-2 rounded hover:bg-pink-600">Fees Update</button>
